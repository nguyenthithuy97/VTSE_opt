...
public class ExportExcel {
	...
	public void writeExcel(List<VerificationReport> reportList) 
		...
		try {
			...
			sheet.addCell(new Label(9, 3, "cfg-variables"));
			sheet.addCell(new Label(10, 3, "formula-variable"));
			...
			for(VerificationReport row: reportList) {
				...
				sheet.addCell(new Label(9, numberOfRow,"" + row.getSizeVariable()));
				sheet.addCell(new Label(10, numberOfRow,"" + row.getNumberOfTotalVariable()));
				numberOfRow++;		
			}

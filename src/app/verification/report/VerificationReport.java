...
//	public static final int UNKNOWN = 3;
	...
	private int numberOfTotalVariable;
	...
	public void print() {
		...
		System.out.println("Total variable: cfg-" + sizeVariable + 
							" formula-" + numberOfTotalVariable );
	...
	public int getNumberOfTotalVariable() {
		return numberOfTotalVariable;
	}

	public void setNumberOfTotalVariable(int numberOfTotalVariable) {
		this.numberOfTotalVariable = numberOfTotalVariable;
	}
}
